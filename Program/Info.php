   ...
   <div class="row">
    ...
    <div class="Campaigns_container">
        ...
        if(isset($_POST['btnSearch']))
        {
            ...
            $squery =" select * from campaigns where Title Like '%$Title%' OR Description LIKE '%$Title%'";
            ...
            echo "There is no Data"; 
                ...
                for ($i=0; $i <$srow ; $i++) { 
                    ...
                    $Title = $sarr['Title'];
                    $PostedDate = $sarr['PostedDate'];
                    
                    $Photo = $sarr['Photo'];
                    $UploadedBy = $sarr['UploadedBy'];
                    $CampaignID = $sarr['CampaignID'];  
                    ...
                    <div class='row'>
                        ...
                        <div class='col-l-9'>
                            <div class='campaign_txt_content'>
                                <h2><a href='CampaignsDetails.php?CampaignID=$CampaignID'> $Title</a></h2>
                                <br>
                                <br>
                                <div>
                                    <h3>UploadedBy : <span>$UploadedBy</span></h3> <h3>$PostedDate</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {
                $dquery="select * from campaigns order by CampaignID desc"; 
                ...
                for ($i=0; $i<$drow ; $i++) { 
                    ...
                    $Title = $darr['Title'];
                    $PostedDate = $darr['PostedDate'];
                    
                    $Photo = $darr['Photo'];
                    $UploadedBy = $darr['UploadedBy'];
                    $CampaignID = $darr['CampaignID'];
